...
//Driver finds and clicks on AllProducts Tab.
		...
		String actualName1 = Parallella.get(0).getText();
		//String actualName2 = Parallella.get(1).getText();
		//String actualName3 = Parallella.get(2).getText();
		//String actualName4 = Parallella.get(3).getText();

		String actualPrice1 = ParallellaPrice.get(0).getText();
		//String actualPrice2 = ParallellaPrice.get(1).getText();
		//String actualPrice3 = ParallellaPrice.get(2).getText();
		//String actualPrice4 = ParallellaPrice.get(3).getText();

//add expected result
		String expectedName1 = "Parallella";
		//String expectedName2 = "Parallella 43R / 43C";
		//String expectedName3 = "Parallella Zero W / Zero WH";
		//String expectedName4 = "Parallella Zero";

		String expectedPrice1 = "$128";
